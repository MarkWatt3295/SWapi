...
public class Logger {
	...
	public static void appLog(String message) throws IOException { 
		...
		PrintWriter writer = new PrintWriter(new FileWriter("SWapi_Log.txt", true), true);
	...
	public static void threadLog(String message) throws IOException { 
		PrintWriter writer = new PrintWriter(new FileWriter("SWapi_Thread_Log.txt", true), true);
